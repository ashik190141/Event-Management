...
const Footer = () => {
    return (
      <div className="bg-[#0F172A]">
        <div className="max-w-[1220px] mx-auto px-[16px] md:px-[10px] lg:px-[0px] border-t-[1px] border-[#b7c3d3]">
